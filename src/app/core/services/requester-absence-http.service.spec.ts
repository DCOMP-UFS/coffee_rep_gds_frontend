...
describe("RequesterAbsenceHttpService", () => {
	...
	it("lists absences with optional solicitanteId", () => {
		...
		req.flush([{ id: 1, solicitanteId: 3, solicitanteNome: "Dr.", dataInicio: "2026-01-01", dataFim: "2026-01-02" }]);
	});

	it("creates absence", () => {
		service
			.create({ solicitanteId: 1, dataInicio: "2026-01-01", dataFim: "2026-01-02" })
			.subscribe();
